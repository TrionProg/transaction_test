...
impl TransactionID {
    pub fn new(local_transaction_id:LocalTransactionID) -> Self {
        TransactionID {
...
impl Transaction {
    ...
    pub fn finish(&mut self) {//а если серверы сломались?
        ...
        */
        ...
        //TODO для удалённых:
        //Отправить им сериализ. сообщение
        //Получить подтверждение
        //Отправить подтверждение

        //Локальные тупо записываем

        //TODO вместо интекса raw::TraitObject
        //TODO сделать всё представление иммутабельным? я не хочу, чтобы юзеры смогли установить другие ссылки
